...
$site_settings = $conn->query("SELECT * FROM site_settings WHERE setting_key IN ('site_title', 'site_keywords', 'site_description', 'footer_text', 'logo_type', 'logo_text', 'logo_image')")->fetch_all(MYSQLI_ASSOC);
    ...
    <header>
        <nav>
            <div class="logo">
                ...
                <?php else: ?>
                    <?php echo htmlspecialchars($settings['logo_text'] ?? '星涵网络工作室'); ?>
                <?php endif; ?>
            </div>
    ...
    <main>
        ...
        <section id="about">
            <div class="section-header">
                <h2><?php echo htmlspecialchars($content['about'][0]['title']); ?></h2>
            ...
            <div class="about-content">
                ...
                <div class="about-text">
                    <p><?php echo nl2br(htmlspecialchars($content['about'][0]['content'])); ?></p>
                </div>
            </div>
        </section>
                    ...
                    <div class="member-info">
                        ...
                        <div class="member-social">
                            <?php if (!empty($member['qq'])): ?>
                                <a href="tencent://message/?uin=<?php echo htmlspecialchars($member['qq']); ?>" class="social-icon" title="QQ"><i class="fab fa-qq"></i></a>
                            <?php endif; ?>
                            <?php if (!empty($member['wechat'])): ?>
                                <a href="#" class="social-icon" title="微信: <?php echo htmlspecialchars($member['wechat']); ?>"><i class="fab fa-weixin"></i></a>
                            <?php endif; ?>
